...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    founders: Schema.Attribute.Component<'about-us.founders', false>;
    hero: Schema.Attribute.Component<'about-us.hero', false>;
    investors: Schema.Attribute.Component<'about-us.investors', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about-us.about-us'> & Schema.Attribute.Private;
    media_kit_banner: Schema.Attribute.Component<'about-us.media-kit-banner', false>;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    open_positions: Schema.Attribute.Component<'about-us.open-positions', false>;
    our_culture: Schema.Attribute.Component<'about-us.our-culture', false>;
    our_resolve: Schema.Attribute.Component<'about-us.our-resolve', false>;
    publishedAt: Schema.Attribute.DateTime;
    structured_data_markup: Schema.Attribute.Component<'about-us.structured-data-markup', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiBookADemoBookADemo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    forbidden_email_domains: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::book-a-demo.book-a-demo'> & Schema.Attribute.Private;
    logos: Schema.Attribute.Component<'book-a-demo.logos', false>;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    publishedAt: Schema.Attribute.DateTime;
    quote: Schema.Attribute.Component<'book-a-demo.quote', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiCommunityPostCommunityPost extends Struct.CollectionTypeSchema {
  collectionName: 'community_posts';
  info: {
    description: '';
    displayName: 'Community_post';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::community-post.community-post'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
    social_media: Schema.Attribute.Enumeration<['linkedin', 'x', 'facebook']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    url: Schema.Attribute.String;
    user: Schema.Attribute.String;
    user_avatar: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    username: Schema.Attribute.String;
  };
}

export interface ApiCustomerPostCustomerPost extends Struct.CollectionTypeSchema {
  collectionName: 'customer_posts';
  info: {
    description: '';
    displayName: 'Customer_post';
    pluralName: 'customer-posts';
    singularName: 'customer-post';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    featuring: Schema.Attribute.Component<'customer-post.featuring', true>;
    highlights: Schema.Attribute.Component<'customer-post.highlights', true>;
    impact: Schema.Attribute.Text;
    industry: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::customer-post.customer-post'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'common.seo', false>;
    slug: Schema.Attribute.UID;
...
export interface ApiCustomerCustomer extends Struct.SingleTypeSchema {
  ...
  attributes: {
    book_a_demo_banner: Schema.Attribute.Component<'customer.book-a-demo-banner', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'customer.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::customer.customer'> & Schema.Attribute.Private;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    publishedAt: Schema.Attribute.DateTime;
    structured_data_markup: Schema.Attribute.Component<'customer.structured-data-markup', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    privacy_policy_link_text: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    social_links: Schema.Attribute.Component<'common.social-links', false>;
    terms_of_service_link_text: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    pages_links: Schema.Attribute.Relation<'oneToMany', 'api::pages-link.pages-link'>;
    privacy_policy_link_text: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    social_links: Schema.Attribute.Component<'common.social-links', false>;
    terms_of_service_link_text: Schema.Attribute.String;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    agentic_ai: Schema.Attribute.Component<'homepage.agentic-ai', false>;
    common_production_issues: Schema.Attribute.Component<'homepage.common-production-issues', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'homepage.hero', false>;
    how_does_resolve_works: Schema.Attribute.Component<'homepage.how-does-resolve-works', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::homepage.homepage'> & Schema.Attribute.Private;
    marquee: Schema.Attribute.Component<'homepage.marquee', false>;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    our_blog: Schema.Attribute.Component<'homepage.our-blog', false>;
    our_community: Schema.Attribute.Component<'homepage.our-community', false>;
    product_view: Schema.Attribute.Component<'homepage.product-view', false>;
    publishedAt: Schema.Attribute.DateTime;
    quotations_section: Schema.Attribute.Component<'homepage.quotations-section', false>;
    structured_data_markup: Schema.Attribute.Component<'homepage.structured-data-markup', false>;
    toils_section: Schema.Attribute.Component<'homepage.toils-section', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    what_is_resolved: Schema.Attribute.Component<'homepage.what-is-resolved', false>;
    why_us: Schema.Attribute.Component<'homepage.why-us', false>;
    work_with_us_banner: Schema.Attribute.Component<'homepage.work-with-us-banner', false>;
  };
}

export interface ApiOurAgenticAiOurAgenticAi extends Struct.SingleTypeSchema {
  collectionName: 'our_agentic_ais';
  info: {
    description: '';
    displayName: 'Our Agentic AI';
    pluralName: 'our-agentic-ais';
    singularName: 'our-agentic-ai';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'our-agentic-ai.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::our-agentic-ai.our-agentic-ai'> &
      Schema.Attribute.Private;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    publishedAt: Schema.Attribute.DateTime;
    slides: Schema.Attribute.Component<'our-agentic-ai.slides', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    structured_data_markup: Schema.Attribute.Component<'our-agentic-ai.structured-data-markup', false>;
    technology_tools: Schema.Attribute.Component<'homepage.how-does-resolve-works', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiPagesLinkPagesLink extends Struct.CollectionTypeSchema {
  collectionName: 'pages_links';
  info: {
    description: '';
    displayName: 'Pages_link';
    pluralName: 'pages-links';
    singularName: 'pages-link';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    children_links: Schema.Attribute.Component<'common.children-links', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    href: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pages-link.pages-link'> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'common.seo', false>;
...
export interface ApiProductProduct extends Struct.SingleTypeSchema {
  ...
  attributes: {
    book_a_demo_banner: Schema.Attribute.Component<'product.book-a-demo-banner', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'product.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::product.product'> & Schema.Attribute.Private;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    product_view: Schema.Attribute.Component<'homepage.product-view', false>;
    production_issues: Schema.Attribute.Component<'product.production-issues', false>;
    publishedAt: Schema.Attribute.DateTime;
    structured_data_markup: Schema.Attribute.Component<'product.structured-data-markup', false>;
    technology_tools: Schema.Attribute.Component<'homepage.how-does-resolve-works', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiSecuritySecurity extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    enterprise_control: Schema.Attribute.Component<'security.enterprise-control', false>;
    hero: Schema.Attribute.Component<'security.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::security.security'> & Schema.Attribute.Private;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    organization_data: Schema.Attribute.Component<'security.organization-data', false>;
    publishedAt: Schema.Attribute.DateTime;
    structured_data_markup: Schema.Attribute.Component<'security.structured-data-markup', false>;
    technology_tools: Schema.Attribute.Component<'homepage.how-does-resolve-works', false>;
    trust_banner: Schema.Attribute.Component<'security.trust-banner', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiSocialMediaSocialMedia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::social-media.social-media'> & Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiTermsOfServiceTermsOfService extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::terms-of-service.terms-of-service'> &
      Schema.Attribute.Private;
    metadata: Schema.Attribute.Component<'seo.metadata', false>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::customer-post.customer-post': ApiCustomerPostCustomerPost;
      'api::customer.customer': ApiCustomerCustomer;
      'api::footer.footer': ApiFooterFooter;
      'api::header.header': ApiHeaderHeader;
      'api::homepage.homepage': ApiHomepageHomepage;
      'api::our-agentic-ai.our-agentic-ai': ApiOurAgenticAiOurAgenticAi;
      'api::pages-link.pages-link': ApiPagesLinkPagesLink;
