        ...
        <>
            <div className='hidden md:flex md:flex-row xl:flex-row 2xl:flex-row md:relative md:w-full md:h-fit md:mt-[7vw] md:px-[5.6vw]'>
                ...
                <div className='w-full xs:pt-[35vw] md:pt-0 xl:pt-0 2xl:pt-0 flex flex-col basis-5/12 mx-[2vw]'>
                    <FadeUp delay={1} className='mb-[2.25vw] uppercase font-black font-dharma-gothic-e text-[5.5vw] md:text-[2.8vw] xl:text-[2.8vw] 2xl:text-[2.8vw] leading-[4.5vw] md:leading-[2.3vw] xl:leading-[2.3vw] 2xl:leading-[2.3vw]'>
                    ...
                    <FadeUp delay={1.5} className='font-normal font-host-grotesk text-[3.5vw] md:text-[1.125vw] xl:text-[1.125vw] 2xl:text-[1.125vw] leading-[4vw] md:leading-[1.65vw] xl:leading-[1.65vw] 2xl:leading-[1.65vw]'>
                    ...
                    <FadeUp delay={2} className='w-full h-fit mt-[2.25vw]'>
