            ...
            <div className='hidden md:flex md:flex-row xl:flex-row 2xl:flex-row md:relative md:w-full md:h-fit md:pt-[3vw]'>
                ...
                <div className='flex flex-row relative px-[5.6vw]'>
                    ...
                    <FadeUp className='relative w-full h-full xs:pt-[35vw] md:pt-0 xl:pt-0 2xl:pt-0 flex flex-col basis-[39%]'>
                        <div className='mb-[2.25vw] uppercase font-black font-dharma-gothic-e text-[3rem] xl:text-[2.8vw] 2xl:text-[2.8vw] leading-[2.5rem] xl:leading-[2.3vw] 2xl:leading-[2.3vw]'>
                        ...
                        <div className='font-normal font-host-grotesk text-[2rem] xl:text-[1.125vw] 2xl:text-[1.125vw] leading-[2rem] xl:leading-[1.65vw] 2xl:leading-[1.65vw]'>
