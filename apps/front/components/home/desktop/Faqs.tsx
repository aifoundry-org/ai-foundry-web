...
export default function Faqs() {
    ...
    return (
        <div className='hidden md:flex md:flex-col md:pt-[21.35vw] md:pb-[7.7vw] md:relative md:w-full md:h-fit md:px-[5.6vw]'>
            <FadeUp>
                <h2 className='font-black font-dharma-gothic-e text-[6.4rem] leading-[5.3rem] uppercase'>
                    Faqs
                </h2>
            </FadeUp>
            <FadeUp>
                <h3 className='font-normal font-host-grotesk text-[1.6rem] leading-[2.4rem] pt-[1.6rem] pb-[4rem] normal-case'>
